angular.module("alch-templates").run(function($templateCache) {
  $templateCache.put("component/templates/table.html",
    ...
    "      All {{ table.start }} results shown are currently selected.  " +
...
angular.module("alch-templates").run(function($templateCache) {
  $templateCache.put("component/templates/tool_bar.html",
    ...
    "  </div>" +
    "  <div class=\"fl\" ng-show=\"table.working\" style=\"font-size:15px;line-height:2;margin-left: 30px;\"><i class=\"spinner\" />Loading...</div>" +
    ...
    return {
        ...
        controller: function($scope){
            ...
            $scope.table.more_results = function(){
                var more = $scope.table.offset > $scope.table.start;
